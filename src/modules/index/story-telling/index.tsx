      ...
      <div className="h-[100vh] py-[60px] lg:py-0 overflow-auto flex items-center z-10" style={{ backgroundImage: `url(/assets/bg-moai1.png)`, backgroundSize: 'cover' }}>
        ...
        <div className='h-full lg:h-auto container relative z-10 bg-transparent'>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-[20px] lg:gap-[60px]">
            <div onWheelCapture={e => e.stopPropagation()} className="lg:max-h-[450px] w-full flex flex-col gap-[8px] md-[20px] lg:pr-[40px] overflow-x-hidden overflow-y-auto">
                      ...
                      {mainSliders.map((slider, idx) => (
                        <SwiperSlide key={idx} className='flex flex-col gap-[10px]'>
                          ...
                          <div className='flex justify-between'>
                            <div className='text-[20px] lg:text-[32px] font-[500]'>{slider.name}</div>
                            <button className='btn-cta px-8 text-xs lg:text-md'>Discover more</button>
                          </div>
                        </SwiperSlide>
                      ))}
                    </Swiper>
