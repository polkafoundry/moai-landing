      ...
      >
        <div className="h-full lg:h-auto container relative z-10 bg-transparent">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div>
              <div
                onWheelCapture={(e) => showAllText && e.stopPropagation()}
              ...
              >
                <FadeEffect show={show} y={50}>
                  ...
                  living on the legendary island of Rapa Nui, which now belongs
                  to Easter Island. They were guided by the Makemake - an
                  ancient god who helped them build the statues of Moai and
                  imbued them with the spirit of Mana, who blessed the Rapa Nui
                  islanders with bravery, strength, prosperity, peace, and
                  protection through its resting eyes.
                </FadeEffect>
                <FadeEffect show={show} y={50}>
                  The Moais are divided into five tribes, representing the
                  natural elements - the Aaren representing earth, the Aegle
                  representing light, the Agni representing fire, the Aqua
                  representing water, and the Adina representing air.
                </FadeEffect>
                ...
                {showAllText && (
                  <>
                    ...
                    <FadeEffect show={show} y={50}>
                      ...
                      Makemake. Natural disasters and diseases began to swarm
                      upon the island, and the people of Rapa Nui slowly
                      disappeared, until no one is seen living in this
                      once-vibrant society.
                    </FadeEffect>
                    <FadeEffect show={show} y={50}>
                      To protect the spirits of Moai, the Makemake hid them away
                      in another shape - something that modern people nowadays
                    ...
                    <FadeEffect show={show} y={50}>
                      ...
                      the world, as modern people continue to explore the
                      ancient ruins of Rapa Nui and piece together the clues
                      left by its vanished residents.
                    </FadeEffect>
                    <FadeEffect show={show} y={50}>
                      The search for Moais is becoming more and more attractive
                      to modern society, as people believe whoever beholds the
                      “Wicked Moai” will receive its blessing and guidance into
                      the future, and discover a long-forgotten secret of the
                      wrath of Makemake.
                    </FadeEffect>
                    <FadeEffect show={show} y={50}>
                      The search for Moais is becoming more and more attractive
                    ...
                    <FadeEffect show={show} y={50}>
                      ...
                      daunting and mysterious stone-faced monoliths, was the
                      result of something else more celestial…
                    </FadeEffect>
                    <FadeEffect show={show} y={50}>
                      Embark on the mystical journey to unveil Rapa Nui’s
                      ancient apocalypse and embrace the malevolent power of
                      Wicked Moai.
                    </FadeEffect>
                  </>
                )}
